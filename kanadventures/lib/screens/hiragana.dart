...
class _HiraganaState extends State<Hiragana> {
  List<Flashcard> kanas = simpleHiraganas;
  List indexes = List<int>.generate(simpleHiraganas.length, (index) => index);

  final total = simpleHiraganas.length;
  ...
  void restartList() {
    indexes = List<int>.generate(simpleHiraganas.length, (index) => index);
    correct = 0;
    setState(() {});
  }
